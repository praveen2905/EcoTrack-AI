...
const TESTIMONIALS = [
  {
    quote:
      "EcoTrack AI completely changed how I think about my daily commute. The AI recommendations are so specific and actually manageable.",
    name: "Sarah Jenkins",
  ...
  {
    quote:
      "The dashboard blew me away. Being able to see my historical trends helps me stay on track with my 30% reduction goals.",
    name: "Marcus Thierno",
  ...
  {
    quote:
      "Best sustainability app on the market. Period. The AI analysis is leagues ahead of the generic calculators I've used before.",
...
const JOURNEY_STEPS = [
  {
    ...
    desc: "A quick 5-minute survey about your daily energy, transport, and consumption habits.",
    right: "Answer questions",
  },
  {
    num: "02",
    label: "AI Analysis",
    desc: "Our proprietary AI calculates your exact carbon tonnage using global standards.",
    right: "EcoTrack Computes",
  },
  {
    num: "03",
    label: "Personalized Roadmap",
    desc: "Tailored strategies based on your unique profile to reduce emissions effectively.",
    right: "Receive recommendations",
  },
  {
    num: "04",
    label: "Track & Earn",
    desc: "Track real-time progress, join global leaderboard challenges, and unlock eco-rewards.",
    right: "Ongoing Impact",
  },
];
...
export default function Home() {
  return (
    <MainLayout fullWidth>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-xl text-muted-foreground max-w-[560px] leading-relaxed">
              Track, reduce, and optimize your carbon footprint with
              precision-engineered AI insights and satisfying gamification.
            </p>
          ...
          {[
            {
              ...
              body: "Log transportation, energy, and consumption data to get an accurate picture of your true environmental impact.",
            },
            {
              icon: <TrendingDown className="w-6 h-6 text-secondary" />,
              bg: "bg-secondary/10",
              title: "AI-Powered Insights",
              body: "Our intelligent engine analyzes your habits and provides actionable, high-impact recommendations tailored just for you.",
            },
            {
              icon: <Star className="w-6 h-6 text-foreground" />,
              bg: "bg-accent",
              title: "Gamified Progress",
              body: "Turn sustainability into a habit. Earn XP, level up, collect badges, and compete on the leaderboard.",
            },
          ].map((f) => (
            <div
              key={f.title}
      ...
      {/* ── Powerful Tools — dark full-width ─────────────────── */}
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-400 max-w-xl mx-auto">
              Our intelligence suite automates the heavy lifting of
              sustainability, providing clear pathways to environmental
              stewardship.
            </p>
          </div>
            ...
            {[
              {
                ...
                title: "Calculate",
                body: "Precision measurement of your lifestyle and business emissions from daily activities using advanced AI modelling.",
              },
              {
                icon: <BarChart2 className="w-6 h-6 text-primary" />,
                title: "Track",
                body: "Monitor your progress over time with intuitive dashboards and real-time data sync across devices.",
              },
              {
                icon: <TrendingDown className="w-6 h-6 text-primary" />,
                title: "Reduce",
                body: "Get actionable AI insights to lower your footprint through personalised habit coaching.",
              },
            ].map((t) => (
              <div
                key={t.title}
                className="bg-white/5 border border-white/10 rounded-2xl p-8 hover:bg-white/8 transition-colors"
                data-testid={`card-tool-${t.title.toLowerCase()}`}
              >
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground max-w-lg mx-auto">
              Our streamlined process makes sustainability accessible to
              everyone.
            </p>
          </div>
      ...
      <section className="w-full bg-[hsl(220_25%_10%)] dark:bg-[hsl(220_25%_8%)] py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Trusted by Conscious Humans
            </h2>
            <p className="text-slate-400 max-w-md mx-auto">
              Join thousands of people reducing their impact every day.
            </p>
          </div>
            ...
            {TESTIMONIALS.map((t) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 pt-2 border-t border-white/10">
                  <div className="w-10 h-10 rounded-full bg-primary/30 flex items-center justify-center text-primary font-bold text-sm flex-shrink-0">
                    {t.initials}
                  </div>
                  <div>
      ...
      <section className="w-full bg-primary py-20 px-4">
        <div className="container mx-auto max-w-3xl text-center">
          ...
          <p className="text-primary-foreground/80 text-lg mb-10 max-w-lg mx-auto">
            Join the movement and start your AI-powered sustainability
            assessment today. It&apos;s free to start.
          </p>
          <Link href="/assess">
            <Button
              size="lg"
              className="h-14 px-10 text-lg rounded-full bg-white text-primary hover:bg-white/90 font-bold shadow-lg"
              data-testid="button-cta-assess"
            >
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between gap-10 mb-12">
            ...
            <div className="max-w-xs">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">
                Empowering individuals and businesses with intelligence-driven
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm">
              <div>
                ...
                <ul className="space-y-2 text-slate-500">
                  ...
                  <li>
                    <Link href="/assess" className="hover:text-primary transition-colors">
                      Assessment
                    </Link>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-slate-500">
                  ...
                  <li>
                    <Link href="/api/healthz" className="hover:text-primary transition-colors">
                      API Docs
                    </Link>
                  </li>
                </ul>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-slate-600 text-sm">
              &copy; {new Date().getFullYear()} EcoTrack AI. Intelligent Sustainability. All rights reserved.
            </p>
            <div className="flex items-center gap-4">
              {[
                ...
                <button
                  key={label}
                  aria-label={label}
                  className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-500 hover:text-primary hover:border-primary/40 transition-colors"
